...
calculateLib proto :ptr qword, :ptr qword, :ptr qword, :ptr qword, 
    :ptr qword, :ptr qword, :ptr qword, :ptr qword, :ptr qword
...
.data?
  ...
  buff db 32 dup(?)
.data 
  labTitle                    db "6-22-IM-13-Sytnyk-noentry-static", 0
